...
PlanePlaneResult IntersectPlanePlane(const Point3d& origin_a,
...
PlanePlaneResult IntersectPlanePlane(const PlaneSurface& a,
                                       const PlaneSurface& b,
                                       const BooleanContext& ctx)
                                       {
  return IntersectPlanePlane(a.Origin(), a.Normal(0, 0), b.Origin(),
                               b.Normal(0, 0), ctx);
}
