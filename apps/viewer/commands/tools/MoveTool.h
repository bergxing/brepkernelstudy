...
/// Move selected primitives in place (Box / Sphere via TransformBody).
class MoveTool final : public ITool
{
public:
...
private:
    ...
    void CommitMove(CommandContext& ctx, const Point3d& place);

    Step m_step{Step::SelectObjects};
    Point3d m_base{};
    std::vector<Guid> m_targets;
