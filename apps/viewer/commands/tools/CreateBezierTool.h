...
/// Progressive rational Bézier: line → parabola → cubic (max 4 CVs).
class CreateBezierTool final : public ITool
{
public:
...
private:
    ...
    static constexpr int kMaxCvs = 4;
    ...
    void CommitBezier(CommandContext& ctx);
